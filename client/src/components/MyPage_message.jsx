    ...
    const MessageDetailCompo = () => {
        ...
        return (
            ...
            <div className={styles.message_content_wrapper}>
                ...
                <div className={styles.message_content_bottom_box} ref={messageContentRef}>
                    {messageListDetail.map((message, index) => (
                        <div className={message.sendUserId === loginId ? styles.sent_message : styles.received_message} key={index}>
                            ...
                            <div>
                                <Image src={message.sendUserId === loginId ? memberInfo.profileImg : messageInfo.profileImg} roundedCircle />
                            </div>
                            <div>
                                <p>{message.content}</p>
                            </div>
